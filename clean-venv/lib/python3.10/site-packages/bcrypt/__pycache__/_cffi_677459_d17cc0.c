...
static PyMethodDef _cffi_methods[] = {
  {"crypt_gensalt_rn", _cffi_f_crypt_gensalt_rn, METH_VARARGS, NULL},
  {"crypt_rn", _cffi_f_crypt_rn, METH_VARARGS, NULL},
...
PyMODINIT_FUNC
init_cffi_677459_d17cc0(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi_677459_d17cc0", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
